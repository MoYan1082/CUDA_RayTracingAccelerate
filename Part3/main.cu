...
void init_scene() {
    ...
    std::cerr << "model faces: " << triangles.size() << std::endl;
    
    // sphere
    //world.push_back(new Sphere(Vec3(-3.6, -8, 2), 2, material1)); // Dielectric
    //world.push_back(new Sphere(Vec3( 3.6, -8, 0), 2, material3)); // metal
    //world.push_back(new Sphere(Vec3( 3.6, -8, 0), 2, material2));

    // cornell box
    // light
    const int light_width = 3;
    //world.push_back(new Triangle(Vec3(light_width, 9.9, light_width), Vec3(light_width, 9.9, -light_width), Vec3(-light_width, 9.9, -light_width), light_material));
    //world.push_back(new Triangle(Vec3(light_width, 9.9, light_width), Vec3(-light_width, 9.9, -light_width), Vec3(-light_width, 9.9, light_width), light_material));
    // top
...
int main() {
    ...
    // hdr
    Texture* hdr_texture_h = new Texture("./resources/BG3.jpg");
